...
public class Task1 {
    ...
    // и будет возвращать арифметическое исключение при попытке поделить число на
    // ноль
    public static double arithmeticException(int a, int b) {
        return a / b;
    }

    // создаем метод, который должен выводить первые несколько элементов (число
    // задается пользователем)
    // и выдает исключения о выходе за пределы массива, если передать ему limit,
    // который будет больше длины массива
    ...
    // при этом, если пользователь ошибся и передал вместо числа какие-то символы,
    // выпадает NumberFormatException
